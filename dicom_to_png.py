# Source: https://github.com/danishm/dicom-to-png
import os
import png
import dicom
import argparse
...
def mri_to_png(mri_file, png_file, x=0, y=0, width=None, height=None):
...
def convert_file(mri_file_path, png_file_path, x=0, y=0, width=None, height=None):
    ...
    try:
        ...
        mri_to_png(mri_file, png_file, x=x, y=y, width=width, height=height)
...
def convert_folder(mri_folder, png_folder, x=0, y=0, width=None, height=None):
        ...
        for mri_file in os.listdir(mri_sub_folder):
            ...
            if os.path.isfile(mri_file_path):
                ...
                try:
                    ...
                    convert_file(mri_file_path, png_file_path, x=x, y=y, width=width, height=height)
